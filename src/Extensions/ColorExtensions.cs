...
namespace FileTransfer.Extensions;
...
public static partial class Extensions
{
    ...
    public static Color DarkenColor(this Color color, float amount) => color.Lerp(Colors.Black, amount);
    ...
    /// <returns>The adjusted color.</returns>
    public static Color BrightenColor(this Color color, float amount) => color.Lerp(Colors.White, amount);
